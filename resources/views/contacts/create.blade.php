...
@section('title', 'Añadir nuevo contacto')

@section('content')

<hr class="hr-text" data-content="Añadir nuevo contacto">
<div class="row justify-content-center">
	<div class="col-lg-7">
		...
		<form action="{{url('contacts')}}" class="text-center" style="color: #757575;" method="post" enctype="multipart/form-data">
			{!! csrf_field() !!}
